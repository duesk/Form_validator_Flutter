        ...
        builder: (BuildContext context, AsyncSnapshot snapshot){
          return Container(
            ...
            child: TextField(
              ...
              obscureText: true,
              decoration: InputDecoration(
                icon: Icon(Icons.https, color: Colors.teal[400]),
    ...
    return Stack(
      children: <Widget>[
        ...
        Container(
          ...
          child: Column(
            children: <Widget>[
              Icon(Icons.fingerprint, color: Colors.white, size: 100.0),
              SizedBox(height: 10.0, width: double.infinity),
              Text("ChingonAPP",style: TextStyle(color: Colors.white, fontSize: 25.0),)
            ]
          ),
        )
